...
class Ui_Dialog(QWidget):
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet(
            "QWidget#Dialog {background-image: url(background.png);background-repeat: no-repeat; background-position: bottom right;}")

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("icon.jpg")),
